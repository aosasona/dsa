...
// A binary search keeps splitting an ORDERED array down the middle only checking other pair(s) based on whether our pivot (mid point) is larger or smaller than the current pile it is checking
